...
function App() {
  ...
  async function loadAuth() {
    ...
    if (!data.ok) {
      setStatus(`Ошибка авторизации: ${data.error}${data.details ? " | " + data.details : ""}`);
      return;
    }
  ...
  async function submit() {
    ...
    try {
      ...
      // После регистрации — обновим auth/profile
      await loadAuth();
  ...
  return (
    <div style={{ padding: 20, fontFamily: "system-ui" }}>
      <h1>GoKart</h1>
      <p style={{ marginTop: 8 }}>Вы в Telegram ✅</p>
